...
make_mcts_params! {
    ...
    tm_opt_value1: f64 = 0.499, 0.1, 1.0, 0.05, 0.002;
    tm_opt_value2: f64 = 0.329, 0.1, 1.0, 0.03, 0.002;
    tm_opt_value3: f64 = 0.645, 0.1, 1.0, 0.06, 0.002;
    tm_scale_value1: f64 = 1.287, 0.1, 2.0, 0.1, 0.002;
    tm_scale_value2: f64 = 2.337, 0.1, 5.0, 0.15, 0.002;
    tm_scale_value3: f64 = 0.537, 0.1, 1.0, 0.05, 0.002;
    tm_scale_value4: f64 = 0.247, 0.1, 1.0, 0.02, 0.002;
    tm_bonus_ply: f64 = 11.263, 1.0, 30.0, 1.5, 0.002;
    tm_bonus_value1: f64 = 0.493, 0.1, 2.0, 0.05, 0.002;
    tm_max_time: f64 = 0.826, 0.400, 0.990, 0.085, 0.002;
}
