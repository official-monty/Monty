...
make_mcts_params! {
    root_pst: f32 = 3.44, 1.0, 10.0, 0.4, 0.002;
    depth_2_pst: f32 = 1.19, 1.0, 10.0, 0.4, 0.002;
    winning_pst_threshold: f32 = 0.69, 0.0, 1.0, 0.05, 0.002;
    winning_pst_max: f32 = 1.43, 0.1, 10.0, 0.4, 0.002;
    root_cpuct: f32 = 0.327, 0.1, 5.0, 0.065, 0.002;
    cpuct: f32 = 0.234, 0.1, 5.0, 0.065, 0.002;
    cpuct_var_weight: f32 = 0.791, 0.0, 2.0, 0.085, 0.002;
    cpuct_var_scale: f32 = 0.292, 0.0, 2.0, 0.02, 0.002;
    cpuct_visits_scale: f32 = 39.81, 1.0, 512.0, 3.2, 0.002;
    expl_tau: f32 = 0.686, 0.1, 1.0, 0.05, 0.002;
    gini_base: f32 = 0.548, 0.2, 2.0, 0.0679, 0.002;
    gini_ln_multiplier: f32 = 1.412, 0.4, 3.0, 0.1634, 0.002;
    gini_min: f32 = 2.137, 0.5, 4.0, 0.21, 0.002;
    knight_value: i32 = 434, 250, 750, 25, 0.002;
    bishop_value: i32 = 435, 250, 750, 25, 0.002;
    rook_value: i32 = 614, 400, 1000, 30, 0.002;
    queen_value: i32 = 1314, 900, 1600, 35, 0.002;
    material_offset: i32 = 574, 400, 1200, 40, 0.002;
    material_div1: i32 = 32, 16, 64, 3, 0.002;
    material_div2: i32 = 1093, 512, 1536, 64, 0.002;
