...
make_mcts_params! {
    ...
    tm_opt_value2: f64 = 0.36, 0.1, 1.0, 0.045, 0.002;
    tm_opt_value3: f64 = 0.80, 0.1, 1.2, 0.08, 0.002;
    tm_optscale_value1: f64 = 1.25, 0.1, 2.0, 0.15, 0.002;
    tm_optscale_value2: f64 = 2.5, 0.1, 5.0, 0.3, 0.002;
    ...
    tm_falling_eval1: f32 = 0.05, 0.0, 0.2, 0.007, 0.002;
    ...
    tm_bmi3: f32 = 3.2, 0.1, 6.4, 0.32, 0.002;
    tm_bmv1: f32 = 2.5, 0.1, 5.0, 0.25, 0.002;
    tm_bmv2: f32 = 0.3, 0.1, 1.0, 0.035, 0.002;
    tm_bmv3: f32 = 0.55, 0.1, 1.0, 0.06, 0.002;
    tm_bmv4: f32 = 4.0, 0.1, 8.0, 0.4, 0.002;
    tm_bmv5: f32 = 0.55, 0.1, 1.0, 0.055, 0.002;
